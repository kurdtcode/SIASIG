    ...
    <div class="main-content box box-success">
        ...
        <div class="box-body">
            <form action="{{ route('manage_task.store') }}" method="POST">
                ...
                <div class="form-group">
                    <h4 for="start_date">Start Date</h4>
                ...
                <div class="form-group">
                    <h4 for="list_id_latihan">List ID Latihan</h4>
                    <input type="text" class="form-control" id="list_id_latihan" name="list_id_latihan" required>
                </div>
                    ...
                    <tbody>
                        @foreach($tasks1 as $task)
                            <tr>
                                ...
                                <td>{{ $task->end_date }}</td>
                                <td>{{ $task->list_id_anggota }}</td>
                                <td>{{ $task->list_id_partitur }}</td>
                                <td>{{ $task->list_id_latihan }}</td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('manage_task.update', $task->id) }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <label for="list_id_latihan">List ID Latihan</label>
                                                    <input type="text" class="form-control" id="list_id_latihan" name="list_id_latihan" value="{{ $task->list_id_latihan }}" required>
                                                </div>
